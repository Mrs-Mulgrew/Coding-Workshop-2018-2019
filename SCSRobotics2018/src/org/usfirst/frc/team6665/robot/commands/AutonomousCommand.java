...
public class AutonomousCommand extends Command {
    ...
    protected void execute() {
    	...
    	if(timer.get()<= 3) {
	  	...
	  	Robot.driveTrain.differentialDrive1.arcadeDrive(0,0.42); // 'turn right'?
	} else if(timer.get()<=7){
		Robot.driveTrain.differentialDrive1.arcadeDrive(-0.6,0);//drive forward
	} else if(timer.get()<=9){
		Robot.driveTrain.differentialDrive1.arcadeDrive(0,0.42); //right?
	} else if(timer.get()<=12){
		Robot.driveTrain.differentialDrive1.arcadeDrive(-0.6,0);
	} else if(timer.get()<=14){
		Robot.driveTrain.differentialDrive1.arcadeDrive(0,0.42);
