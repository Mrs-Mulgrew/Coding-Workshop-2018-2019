...
public class AutonomousCommand extends Command {
    ...
    protected void execute() {
	   ...
	   else if(timer.get()<= 5) {Robot.driveTrain.differentialDrive1.arcadeDrive(0,4.6);//turn right?
				     
        }
	   else if(timer.get()<= 7) {Robot.driveTrain.differentialDrive1.arcadeDrive(-0.6,0);//drive "forward"
        						// (speed/output from motor,rotation angle)
	}
	   else if(timer.get()<= 9) {Robot.driveTrain.differentialDrive1.arcadeDrive(0,4.6);//turn right?
        						// (speed/output from motor,rotation angle)
        }
	   else if(timer.get()<= 12) {Robot.driveTrain.differentialDrive1.arcadeDrive(-0.6,0);//drive "forward"
        						// (speed/output from motor,rotation angle)
        }
	   else if(timer.get()<= 14) {Robot.driveTrain.differentialDrive1.arcadeDrive(0,4.6);//turn right?
        						// (speed/output from motor,rotation angle)
        }
	   else if(timer.get()<= 16) {Robot.driveTrain.differentialDrive1.arcadeDrive(-0.6,0);//drive "forward"
        						// (speed/output from motor,rotation angle)
        }
	   else if(timer.get()<= 18) {Robot.driveTrain.differentialDrive1.arcadeDrive(0,4.6);//turn right?
        						// (speed/output from motor,rotation angle)
        }
